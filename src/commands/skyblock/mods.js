      ...
      const modsEmbed = new EmbedBuilder()
        ...
        .addFields(
          ...
          },
          {
            name: "Chat Triggers",
            value:
              "A powerful and dynamic scripting platform for Minecraft based on flexibility and personalization.\n[Website](https://www.chattriggers.com/)\n[GitHub](https://github.com/ChatTriggers/ChatTriggers)",
          },
          {
            name: "Dankers Skyblock Mod",
            value:
              "Quality of Life changes that enhance your Hypixel Skyblock experience.",
          },
          {
            name: "Dungeons Guide",
            value:
              "A mod designed to help Hypixel Skyblock Dungeons players find secrets and solve puzzles. Also comes with lots of Quality of Life features.",
          },
          {
            name: "Skyblock Extras (Paid)",
            value:
              "Enhancements for Hypixel Skyblock. Includes additional features and optimizations.\n[Website](https://skyblockextras.com)\n[Discord Server](https://discord.gg/sbe)",
          },
          {
            name: "Cowlection",
            value:
          ...
          },
          {
            ...
            value:
              "Mods that improve the visual appearance and performance of Minecraft.",
          },
          {
          ...
          },
          {
            name: "Content Mods",
            value:
              "Mods that add new content or gameplay elements to Minecraft.",
          },
          {
            name: "SoopyV2Forge",
            value:
