  ...
  data: new SlashCommandBuilder()
    ...
    .addSubcommand(subcommand =>
      subcommand
        ...
        .addChannelOption(option => option.setName("feedback-channel").setDescription("The channel for Feedbacks.").setRequired(true)) // Option to specify the feedback channel
    )
    .addSubcommand(subcommand =>
      subcommand
      ...
      subcommand
        ...
        .addStringOption(option =>
            option.setName('star')
                ...
                .setRequired(true)
                .addChoices({ name:'⭐', value: '⭐'}, // Choices for rating feedback with stars
                            { name:'⭐⭐', value: '⭐⭐'},
                            { name:'⭐⭐⭐', value: '⭐⭐⭐'},
                            { name:'⭐⭐⭐⭐', value: '⭐⭐⭐⭐'},
                            { name:'⭐⭐⭐⭐⭐', value: '⭐⭐⭐⭐⭐'}
    ...
    switch (subcommand) {
      case "setup":
        ...
        if (data) {
          const alreadyEmbed = new EmbedBuilder()
              .setColor(`#020202`)
              .setDescription(`Looks like you already have the feedback system set!`);
          ...
          const feedbacksetup = new EmbedBuilder()
              .setColor('#020202')
              .setDescription(`Feedback system has now been configured. To disable, run \`feedback disable\`!`)
              .addFields(
      ...
      case "disable":
        ...
        if (!data) {
          ...
          .setColor(`#020202`)
          .setDescription(`Looks like you don't already have a feedback system set up!`)
      ...
      case "send":
        ...
        if (!data ) {
          ...
          .setColor(`#020202`)
          .setDescription(`The feedback system is not set up here, use \`feedback setup\` to setup it!`)
        ...
        const embed1 = new EmbedBuilder()
            .setColor('#020202')
            .setDescription(`Your feedback successfully sent in ${feedbackChannel}!`);
