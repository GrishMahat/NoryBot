...
module.exports = {
  data: new SlashCommandBuilder()
    ...
    .addStringOption(option => option.setName('name').setDescription('The name of the anime to search').setRequired(true)),
  ...
  run: async (client, interaction) => {
    ...
    try {
      ...
      const embed = new EmbedBuilder()
        ...
        .setColor('#66FFFF')
        .addFields(
          { name: 'Episodes',         value: `${animeData.episodes || 'N/A'}`,                                    inline: true, },
          { name: 'Status',           value: `${animeData.status}`,                                               inline: true, },
          { name: 'Average Score',    value: `${animeData.averageScore}/100`,                                     inline: true, },
          { name: 'Mean Score',       value: `${animeData.meanScore}/100`,                                        inline: true, },
          { name: 'Season',           value: `${animeData.season} - ${animeData.startDate.year}`,                 inline: true, },
